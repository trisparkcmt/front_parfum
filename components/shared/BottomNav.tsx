...
const BottomNav = () => {
  return (
    <nav
      className="fixed bottom-5git add left-4 right-4 bg-[var(--t-nav-bg)]/95 backdrop-blur-xl border border-[var(--t-nav-border)]/50 z-[100] md:hidden shadow-2xl rounded-3xl"
