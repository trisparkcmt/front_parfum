        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              {/* Instagram */}
              <a
                href="https://www.instagram.com/accessoires_exclusifsoff/"
                target="_blank"
              ...
              <a 
                href="https://www.facebook.com/p/Accessoires-exclusifsoff-61574572847440/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-2 bg-foreground/5 hover:bg-foreground/10 rounded-xl transition-all hover:scale-105" 
                aria-label="Facebook"
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-5 h-5">
                  ...
                  <path fill="#fff" d="M4.868,43.803c-0.132,0-0.26-0.052-0.355-0.148c-0.125-0.127-0.174-0.312-0.127-0.483l2.639-9.636c-1.636-2.906-2.499-6.206-2.497-9.556C4.532,13.238,13.273,4.5,24.014,4.5c5.21,0.002,10.105,2.031,13.784,5.713c3.679,3.683,5.704,8.577,5.702,13.781c-0.004,10.741-8.746,19.48-19.486,19.48c-3.189-0.001-6.344-0.788-9.144-2.277l-9.875,2.589C4.953,4.798,4.911,4.803,4.868,4.803z"></path>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-5 h-5">
                  <path fill="#212121" fillRule="evenodd" d="M10.904,6h26.191C39.804,6,42,8.196,42,10.904v26.191C42,39.804,39.804,42,37.096,42H10.904C8.196,42,6,39.804,6,37.096V10.904C6,8.196,8.196,6,10.904,6z" clipRule="evenodd" />
                  <path fill="#ec407a" fillRule="evenodd" d="M29.208,20.607c1.576,1.126,3.507,1.788,5.592,1.788v-4.011c-.395,0-.788-.041-1.174-.123v3.157c-2.085,0-4.015-.663-5.592-1.788v8.184c0,4.094-3.321,7.413-7.417,7.413-1.528,0-2.949-.462-4.129-1.254 1.347,1.376,3.225,2.23,5.303,2.23 4.096,0,7.417-3.319,7.417-7.413V20.607z" clipRule="evenodd" />
                  <path fill="#fff" fillRule="evenodd" d="M28.034,19.63c1.576,1.126,3.507,1.788,5.592,1.788v-3.157c-1.164-.248-2.194-.856-2.969-1.701-1.326-.827-2.281-2.191-2.561-3.788h-2.923V28.79c-.007,1.867-1.523,3.379-3.393,3.379-1.102,0-2.081-.525-2.701-1.338-1.107-.558-1.866-1.705-1.866-3.029 0-1.873,1.519-3.391,3.393-3.391.359,0,.705.056,1.03.159V21.38c-4.024.083-7.26,3.369-7.26,7.411 0,2.018.806,3.847,2.114,5.183 1.18.792,2.601,1.254,4.129,1.254 4.096,0,7.417-3.319,7.417-7.413V19.63z" clipRule="evenodd" />
                  <path fill="#81d4fa" fillRule="evenodd" d="M33.626,18.262v-.854c-1.05.002-2.078-.292-2.969-.848.788.863,1.826,1.458,2.969,1.702z M28.095,12.772c-.027-.153-.047-.306-.061-.461v-.516h-4.036v16.019c-.006,1.867-1.523,3.379-3.393,3.379-.549,0-1.067-.13-1.526-.362.62.813,1.599,1.338,2.701,1.338 1.87,0,3.386-1.512,3.393-3.379V12.772h2.922z M21.635,21.38v-.909c-.337-.046-.677-.069-1.018-.069-4.097,0-7.417,3.319-7.417,7.413 0,2.567,1.305,4.829,3.288,6.159-1.308-1.336-2.114-3.165-2.114-5.183 0-4.042,3.237-7.328,7.261-7.411z" clipRule="evenodd" />
                </svg>
              </a>
            </div>
          </div>
