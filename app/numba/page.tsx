...
export default function NumbaLanding() {
  return (
    <div className="min-h-[85vh] flex flex-col items-center justify-center relative overflow-hidden bg-deep-black">
      {/* Background */}
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1615397323166-512089408215?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-luminosity" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-cream/70 max-w-2xl mx-auto mb-16 font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Link href="/numba/ai-consultant">
              ...
              >
                ...
                <div className="w-16 h-16 rounded-2xl bg-gold text-deep-black flex items-center justify-center mb-6 shadow-lg shadow-gold/20">
                  <Sparkles size={32} />
                </div>
