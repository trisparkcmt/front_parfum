...
export default function Home() {
  ...
  // client-side theme/auth state settles — it's independent of product
  // data now, since FlashSales fetches and owns its own bestseller/
  // hotseller state internally.
  if (!mounted) {
    return <HomeLoadingScreen />;
  }
