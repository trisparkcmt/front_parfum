    ...
    return (
      ...
      >
        ...
        <h1 className="font-display text-3xl font-bold mb-4">
          {t('password_changed', { defaultValue: 'Mot de passe modifié !' })}
        </h1>
    ...
    >
      <div className="mb-8">
        <h1 className="font-display text-3xl font-bold mb-2">
          {t('new_password_title', { defaultValue: 'Nouveau mot de passe' })}
        </h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <Input
          label={t('new_password_field', { defaultValue: 'Nouveau mot de passe' })}
          type="password"
          placeholder="••••••••"
          icon={<Lock size={18} />}
        ...
        <Input
          label={t('confirm_new_password_field', { defaultValue: 'Confirmer le mot de passe' })}
          type="password"
          placeholder="••••••••"
          icon={<Lock size={18} />}
