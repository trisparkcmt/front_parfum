      ...
      <div>
        ...
        <div className="space-y-4">
          {pendingTasks.map(task => (
            <div key={task.id} className="bg-charcoal border border-white/10 rounded-2xl p-4 md:p-6 shadow-lg shadow-black/20">
              ...
              <div className="space-y-3 text-sm mb-6">
                ...
                <div className="flex items-center justify-between bg-white/5 p-3 rounded-xl mt-4 border border-white/5">
