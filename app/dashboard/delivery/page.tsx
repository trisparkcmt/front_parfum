    ...
    <div className="space-y-6 px-4 sm:px-6">
      ...
      <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-2xl p-6 text-foreground relative overflow-hidden shadow-sm shadow-emerald-500/20">
        <div className="absolute top-0 right-0 text-white/10">
          <DeliveryTruckIcon className="h-[120px] w-[120px]" />
        </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white mb-3 group-hover:scale-110 transition-transform">
            <DeliveryTruckIcon className="h-5 w-5" />
          </div>
