...
export default function AdminProfilePage() {
  ...
  return (
    <>
      ...
      <BackButton href="/dashboard/admin/dashboard" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          {/* Details */}
          <div className="bg-gray-800/5 rounded-2xl border border-white/10  overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <div className="p-2.5 bg-gray-500/5 rounded-lg text-sm text-foreground">
                  {user?.firstName}
                </div>
              </div>
              <div>
          ...
          <div className="bg-gray-800/5 rounded-2xl border border-white/10  overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-500/5 rounded-xl">
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-500/5 rounded-xl">
                ...
                <button
                  ...
                  className="text-xs bg-gray-500/5 text-foreground px-3 py-1.5 rounded-lg font-medium hover:bg-white/10 transition-colors"
                >
                  {t('change', 'Changer')}
                </button>
              </div>

              <div className="flex items-center justify-between p-4 bg-gray-500/5 rounded-xl border border-white/10">
                <div className="flex items-center gap-3">
