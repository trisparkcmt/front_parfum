...
import { Search, Eye, CheckCircle, Truck, Loader2, RefreshCw } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-foreground/40 mt-0.5">Suivi, validation et assignation des commandes clients</p>
        </div>
        <button
          onClick={fetchOrders}
