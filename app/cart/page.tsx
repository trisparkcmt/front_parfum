          ...
          <AnimatePresence>
            {items.map((item) => (
              <motion.div
                ...
                className="flex gap-6 p-4 rounded-2xl bg-white/5 border border-white/10"
              >
                {/* Image placeholder based on type */}
                <div className="w-24 h-24 shrink-0 rounded-xl bg-white/10 overflow-hidden relative border border-white/5">
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-28 p-6 rounded-3xl glass-dark border border-white/10">
            ...
            {!promoCode ? (
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 mb-8">
