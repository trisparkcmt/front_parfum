    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="border-b border-white/10 pb-6">
        ...
        <h1 className="text-4xl font-serif font-bold text-foreground mt-2">
          {t('terms_title', { defaultValue: isEn ? "Terms & Conditions" : "Conditions Générales d'Utilisation" })}
        </h1>
        <p className="text-xs text-foreground/40 mt-1 uppercase tracking-widest">
          {t('terms_last_updated', { defaultValue: isEn ? "Last updated: July 1, 2026" : "Dernière mise à jour : 1er Juillet 2026" })}
        </p>
      </div>
      ...
      <div className="space-y-6 text-sm text-foreground/80 leading-relaxed font-sans">
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-foreground font-serif">
            1. {t('terms_sec1_title', { defaultValue: isEn ? "Acceptance of Terms" : "Acceptation des conditions" })}
          </h2>
          <p>
            {t('terms_sec1_desc', {
              defaultValue: isEn 
                ? "By accessing and placing an order on Accessoires Exclusifs, you confirm that you are in agreement with and bound by the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire website and any email or other type of communication between you and Accessoires Exclusifs."
                : "En accédant et en passant une commande sur Accessoires Exclusifs, vous confirmez que vous êtes d'accord avec et lié par les conditions d'utilisation contenues dans les Conditions Générales d'Utilisation décrites ci-dessous. Ces conditions s'appliquent à l'ensemble du site web et à toute communication entre vous et Accessoires Exclusifs."
            })}
          </p>
        </section>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-foreground font-serif">
            2. {t('terms_sec2_title', { defaultValue: isEn ? "Products and Atelier Olfactif" : "Produits et Atelier Olfactif" })}
          </h2>
          <p>
            {t('terms_sec2_desc', {
              defaultValue: isEn
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-foreground font-serif">
            3. {t('terms_sec3_title', { defaultValue: isEn ? "Delivery & Payments" : "Livraison & Paiements" })}
          </h2>
          <p>
            {t('terms_sec3_desc', {
              defaultValue: isEn
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-foreground font-serif">
            4. {t('terms_sec4_title', { defaultValue: isEn ? "User Account & Security" : "Compte Utilisateur & Sécurité" })}
          </h2>
          <p>
            {t('terms_sec4_desc', {
              defaultValue: isEn
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-foreground font-serif">
            5. {t('terms_sec5_title', { defaultValue: isEn ? "Contact Us" : "Contactez-nous" })}
          </h2>
          <p>
            {t('terms_sec5_desc', {
              defaultValue: isEn
